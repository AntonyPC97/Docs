...
extern void ContarVotosAsm (int cant , float *v, float * asmh);
...
int main(int argc, char** argv) {
    ...
    printf("El speedup de C con respecto a ASM es %.6f \n",1000000*((float)(ctotal/atotal))/CLOCKS_PER_SEC);
    return 0;
}
